...
class TestUUID5Generation:
    ...
    def test_get_composite_uuid5_basic(self, sample_dataframe):
    ...
    def test_get_composite_uuid5_multiple_fields(self, sample_dataframe):
    ...
    def test_get_composite_uuid5_duplicate_detection(self):
...
class TestPmidToSraIdFetching:


    @patch('modules.gather_sra_data.Entrez')
    def test_fetch_sra_ids_success(self, mock_entrez, mock_entrez_response):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_fetch_sra_ids_no_results(self, mock_entrez):
    ...
    def test_fetch_sra_ids_rate_limit_retry(self, mock_sleep, mock_entrez):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_fetch_sra_ids_permanent_error(self, mock_entrez):
    ...
    def test_get_sra_ids_for_pubmed_ids(self, mock_fetch):
...
class TestDataAggregation:
    ...
    def test_merge_semicolon_fields(self):
    ...
    def test_merge_semicolon_fields_with_empty(self):
    ...
    def test_merge_semicolon_fields_all_empty(self):
    ...
    def test_aggregate_batch_mappings(self):
    ...
    def test_aggregate_batch_mappings_dedup_prefers_nonempty(self):
    ...
    def test_aggregate_batch_srp_data(self):
...
class TestBatchManagement:
    ...
    def test_get_max_batch_number(self, sample_batch_dir):
        """Test extracting the maximum batch number from directory."""
        max_batch = get_max_batch_number(sample_batch_dir)
        assert max_batch == 2


    def test_get_max_batch_number_empty_dir(self, tmp_path):
    ...
    def test_load_processed_pmids_from_batches(self, sample_batch_dir):
    ...
    def test_load_processed_pmids_from_batches_no_dir(self, tmp_path):
...
class TestFailedPmidReporting:


    @patch('modules.gather_sra_data.config')
    def test_save_failed_pmids_report(self, mock_config, tmp_path):
    ...
    @patch('modules.gather_sra_data.config')
    def test_save_failed_pmids_report_empty_dict(self, mock_config, tmp_path):
    ...
    @patch('modules.gather_sra_data.config')
    def test_load_failed_pmids_report(self, mock_config, tmp_path):
    ...
    @patch('modules.gather_sra_data.config')
    def test_load_failed_pmids_report_no_file(self, mock_config, tmp_path):
...
class TestHelperFunctions:
    ...
    def test_create_blank_metadata_dict(self):
    ...
    def test_create_sra_mapping_dataframe(self, sample_mapping_data):
    ...
    def test_create_sra_mapping_dataframe_empty(self):
    ...
    def test_create_srp_centric_dataframe(self):
...
class TestIntegration:
    ...
    def test_full_uuid_generation_workflow(self, sample_dataframe):
    ...
    @patch('modules.gather_sra_data.fetch_sra_ids')
    def test_mapping_to_srp_workflow(self, mock_fetch):
...
class TestEdgeCases:
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_duplicate_pmid_handling(self, mock_entrez):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_no_sra_match(self, mock_entrez):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_erp_match(self, mock_entrez):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_many_to_one_srp_mapping(self, mock_entrez):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_bad_pmid_input(self, mock_entrez):
...
class TestSrpIdFetching:


    @patch('modules.gather_sra_data.Entrez')
    def test_get_srp_ids_for_sra_id_success(self, mock_entrez):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_get_srp_ids_for_sra_id_no_results(self, mock_entrez):
    ...
    def test_get_srp_ids_for_sra_ids_batch(self, mock_get_srp):
...
class TestMetadataFetching:
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_fetch_sra_metadata_for_srp_success(self, mock_entrez, mock_xml_metadata):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_fetch_sra_metadata_for_srp_api_error(self, mock_entrez):
    ...
    @patch('modules.gather_sra_data.Entrez')
    def test_fetch_sra_metadata_for_srp_no_study_section(self, mock_entrez):
...
class TestDataEnrichment:
    ...
    def test_enrich_srp_data_with_metadata(self):
    ...
    @patch('modules.gather_sra_data.config')
    def test_get_dataset_doc_from_project_no_publication_file(self, mock_config, tmp_path):
    ...
    @patch('pandas.read_csv')
    def test_get_dataset_doc_from_project_missing_columns(self, mock_read_csv, mock_exists, mock_config):
...
class TestBatchFileOperations:
    ...
    def test_load_all_batch_files(self, tmp_path):
    ...
    def test_load_all_batch_files_empty_dir(self, tmp_path):
...
class TestRealWorldScenarios:
    ...
    def test_workflow_with_mixed_results(self, mock_get_srp, mock_fetch_sra):
...
class TestCreateSrpToSraMapping:


    def test_create_srp_to_sra_mapping_basic(self):
    ...
    def test_create_srp_to_sra_mapping_empty(self):
...
class TestGatherSrpMetadata:


    @patch('modules.gather_sra_data.fetch_sra_metadata_for_srp')
    def test_gather_srp_metadata_basic(self, mock_fetch):
...
class TestJsonBatchPersistence:


    def test_json_batch_roundtrip(self, tmp_path):
...
class TestGetMaxBatchNumberEdgeCases:


    def test_get_max_batch_number_nonexistent_dir(self):
    ...
    def test_get_max_batch_number_no_matching_files(self, tmp_path):
...
class TestEnrichSrpDataEdgeCases:


    def test_enrich_srp_data_merges_metadata_and_mapping_pmids(self):
...
class TestAggregateBatchMappingsEdgeCases:


    def test_aggregate_batch_mappings_empty_input(self):
    ...
    def test_aggregate_batch_mappings_no_pmid_column(self):
...
class TestValidateAndDropIncompleteStudies:


    def test_validate_drops_missing_title(self, tmp_path):
    ...
    def test_validate_drops_missing_description(self, tmp_path):
    ...
    def test_validate_drops_both_missing(self, tmp_path):
    ...
    def test_validate_no_drops_all_valid(self, tmp_path):
    ...
    def test_validate_treats_whitespace_as_missing(self, tmp_path):
    ...
    def test_validate_preserves_all_columns(self, tmp_path):
    ...
    def test_validate_resets_index(self, tmp_path):
